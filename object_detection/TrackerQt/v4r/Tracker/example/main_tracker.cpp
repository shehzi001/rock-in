...
int main(int argc, char *argv[])
{
  ...
  // Read inifile
  std::string ini_file = std::string(V4R_DIR) + "/v4r/Tracker/example/Resources/tracking.ini";
  std::string cam_cal_file = std::string(V4R_DIR) + "/v4r/Tracker/example/Resources/cam.cal";
  std::string pose_cal_file = std::string(V4R_DIR) + "/v4r/Tracker/example/Resources/pose.cal";
  std::string video_file = std::string(V4R_DIR) + "/v4r/Tracker/example/Resources/0028.avi";
