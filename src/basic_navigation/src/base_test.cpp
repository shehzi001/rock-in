...
int main(int argc, char **argv)
{
  ...
  //{positions: [ {joint_uri: arm_joint_1, unit: rad, value: 2.93812}, 
 // {joint_uri: arm_joint_2, unit: rad, value: 1.04351}, 
 // {joint_uri: arm_joint_3, unit: rad, value: -2.44154}, {joint_uri: arm_joint_4, unit: rad, value: 1.83102}, 
  //{joint_uri: arm_joint_5, unit: rad, value: 2.96447} ]}'
   ...
   // vel.linear.y = -0.1;
    ...
    joints.joint_uri = "arm_joint_3";
    joints.unit = "rad";
    joints.value = static_cast<double>(-5.02655);
    ...
    joints.joint_uri = "arm_joint_5";
    joints.unit = "rad";
    joints.value = static_cast<double>(0.110619);
