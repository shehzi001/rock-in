...
bool ModelLoader::LoadPly(TrackerModel &model, const char* filename){
  ...
  for(i=0; i<num_passes; i++){
    ...
    p->modelviewprojection[0] = plypasslist[i].m0;
    p->modelviewprojection[1] = plypasslist[i].m1;
    p->modelviewprojection[2] = plypasslist[i].m2;
    p->modelviewprojection[3] = plypasslist[i].m3;
    p->modelviewprojection[4] = plypasslist[i].m4;
    p->modelviewprojection[5] = plypasslist[i].m5;
    p->modelviewprojection[6] = plypasslist[i].m6;
    p->modelviewprojection[7] = plypasslist[i].m7;
    p->modelviewprojection[8] = plypasslist[i].m8;
    p->modelviewprojection[9] = plypasslist[i].m9;
    p->modelviewprojection[10] = plypasslist[i].m10;
    p->modelviewprojection[11] = plypasslist[i].m11;
    p->modelviewprojection[12] = plypasslist[i].m12;
    p->modelviewprojection[13] = plypasslist[i].m13;
    p->modelviewprojection[14] = plypasslist[i].m14;
    p->modelviewprojection[15] = plypasslist[i].m15;
    ...
    if(!p->texture.Load(texFilenames[i].c_str(), true))
    {
      printf("[ModelLoader::LoadPly] Error loading texture '%s'\n", texFilenames[i].c_str());
    }else
    {
...
bool ModelLoader::SavePly(TrackerModel &model, const char* name)
{
  ...
  for(i=0; i<model.m_passlist.size(); i++){
    ...
    for(j=0; j<16; j++){
      sprintf(number, " %f", p->modelviewprojection[j]);
      fputs(number, pFile);
    }
